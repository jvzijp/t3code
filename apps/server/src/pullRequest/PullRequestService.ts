...
/**
 * The provider-native repository selector, shared with the clients as `pullRequestRepositoryOf`
 * so a request built there names the repository the way `requireProject` checks it.
 *
